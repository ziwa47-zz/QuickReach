...
/**
 * Servlet implementation class SubmitTosShipped
 */
@WebServlet("/SubmitToShipped")
public class SubmitToShipped extends HttpServlet {
	...
	System.out.println("�����:"+list);
		...
		try {
			...
			response.sendRedirect("QROrders/OrderUploadTrackingCode.jsp");
			ps.close();
			conn.close();
