...
//				System.out.println(rpr.getTotalNumberOfPages());
	...
	private static void displayOrders(ArrayList<OrderType> od,Connection conn)
		...
		for (int i = 0; i < size; i++) {
			...
			if ("COMPLETE".equals(order.getCheckoutStatus().getStatus().toString())) {
				if (!checkExist(order,conn)) {
					...
					ps.setDouble(20,
							order.getMonetaryDetails().getPayments().getPayment()[0].getPaymentAmount().getValue()
									- order.getMonetaryDetails().getPayments().getPayment()[0].getFeeOrCreditAmount()
											.getValue());
					...
					System.out.println(Street1+" "+Street2 + "," + PostalCode + "," +CityName +"," + StateOrProvince +"," + CountryName);
					
					
					
					
					ps2.setString(7, Street1+" "+Street2 + "," + PostalCode + "," +CityName +"," + StateOrProvince +"," + CountryName);
...
//						System.out.println(
//								"MonetaryDetails 付費總額:" + order.getMonetaryDetails().getPayments().getPayment()[k]
...
//					System.out.println(
//							"訂單長度:" + new Integer(order.getTransactionArray().getTransaction().length).toString());
...
//					System.out.println("收件人國家getCounty:" + order.getShippingAddress().getCounty());
//					System.out.println("收件人國家名getCountryName:" + order.getShippingAddress().getCountryName());
//					System.out.println("收件人城市名getCityName:" + order.getShippingAddress().getCityName());
//					System.out.println("收件人公司getCompanyName:" + order.getShippingAddress().getCompanyName());
...
//
//						System.out
//								.println("商品名:" + order.getTransactionArray().getTransaction()[l].getItem().getTitle());
//						System.out.println("SKU:" + order.getTransactionArray().getTransaction()[l].getItem().getSKU());
//						System.out.println(
//								"Price:" + order.getTransactionArray().getTransaction()[l].getItem().getCeilingPrice());
//						System.out.println(
//								"itemid:" + order.getTransactionArray().getTransaction()[l].getItem().getItemID());
