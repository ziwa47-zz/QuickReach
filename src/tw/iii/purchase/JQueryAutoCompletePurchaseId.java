...
@WebServlet(name = "JQueryAutoCompletePurchaseId", urlPatterns = { "/JQueryAutoCompletePurchaseId" })
public class JQueryAutoCompletePurchaseId extends HttpServlet {
	...
	private void processSKU(HttpServletRequest request, HttpServletResponse response) throws Exception {
		...
		String searchPurchaseId = request.getParameter("term");
		System.out.println("term:"+searchPurchaseId);
