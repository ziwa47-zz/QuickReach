...
<body><%@ include file="/href/navbar.jsp" %>
  ...
  <div class="container" >
  	<form name="searchform" method="post" action="#" style="font-size: 100%; vertical-align: baseline;" class=" form-group container">
          ...
          <input type="hidden">
              ...
              <div class="container-fluid form-horizontal">
                  ...
                  <div class="row">
                      ...
                      <div class="col-md-5 well-sm"><input class="checkbox-inline" type="file" ></div>
                  </div>
                  <div class="row">
                      <div class="col-md-3 text-right well-sm label-tag"  ><h4>帳號狀態</h4></div>
                      <div class="col-md-5 well-sm">
                      	
                      	<label class="checkbox-inline"><input type="radio" id="id_fd-is_active_0" value="1" name="fd-is_active" checked/> 有效</label>
					 	<label class="checkbox-inline"><input type="radio" id="id_fd-is_active_1" value="0" name="fd-is_active" /> 停用</label>
