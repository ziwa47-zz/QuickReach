  ...
  <div class="container">
    <div class="nav" style="background-color:#984AC0;" >
      <ul class="nav nav-tabs">
        ...
        <li><a href="addWarehouse.jsp" style="color: #fff">新增倉庫</a></li>
      </ul>
    </div>
  </div>
</div>
    ...
    <fieldset id="myfields" class="font-weight" style="padding:0 30px 0 0;">
      ...
      <div class="container-fluid form-horizontal">
        ...
        <div class="row">
          ...
          <div class="col-md-5 well-sm">
            <input class="form-control" name="warehouseName" type="text" >
          </div>
        </div>
       ...
       <div class="row text-center" id="formSubmit">
						<button type="submit" id="submitButton" name="submitButton" class="btn-lg btn-success" value="addWarehouse" >送出</button>
					</div>
      </div>
    </fieldset>
  </form>
