...
<%
	...
	LinkedList<COrders> orderList = COrderFactory.orders(request,conn,"未完成");
    ...
    style="font-size: 100%; vertical-align: baseline; padding: 15px;">
      <fieldset class="font-weight" style="padding:0 30px 0 0;">
        ...
        <div class="row text-center" >
          <input type="hidden" name="undo"  value="undo"> <!-- 控制搜尋結果在未完成 -->
    ...
    <c:when test="${SearchOrdersResult != null}">
      <div class="container table-responsive bg-warning" style=" border-radius:20px">
        <form name="searchform" method="post" action="../StatusDo" class="form-inline container"
		  ...
		  <button type="submit" name="send" value="deleteUndo" class="btn btn-md btn-info">刪除訂單</button>
              ...
              <c:choose>
                <c:when test="${check.index%2 != 0}">
                  <tr style="background-color:#D4F4D8">
                    ...
                    <td><a href="NewOrder.jsp?QR_id=${i.getCOrderMaster().getQR_id()}"><img src="../img/compose-4.png" ></a></td>
