...
<script src="../js/jquery-ui.min.js"></script>
 ...
 %>
  <div class="nav">
    ...
    <div class="container">
   	  <div class="nav" style="background-color:#A45A21;" id="statusChioce" >
        <ul class="nav nav-tabs">
          <li><a href="SearchOrder.jsp" style="color:#000000">訂單查詢</a></li>
          <li><a href="OrderProcessingPage.jsp" style="color:#000000">處理中</a></li>
          <li><a href="OrderPickupPage.jsp" style="color:#fff">揀貨中</a></li>
    	...
    	<input type="hidden">
          ...
          <div class="row">
            ...
            <div class="row">
              ...
              <div class="col-md-8 form-group ">
                <div class="row">
                  ...
                  <div class="col-md-10">
                      <input class="form-control date" type="text" name="payDateMin">
                      <label for="focusedInput ">~</label>
                    <input class="form-control date" type="text" name="payDateMax">
                  </div>
                </div>
              </div>               
            </div>
            <div class="row">
              <div class="col-md-8 form-group ">
                <div class="row">
                  ...
                  <div class="col-md-10">
                      <input class="form-control date" type="text" name="shippingDateMin" id="date">
                      <label for="focusedInput ">~</label>
                    <input class="form-control date" type="text" name="shippingDateMax">
                  </div>
                </div>
              </div> 
            </div>
            ...
            <div class="row text-center" >     
				<button type="submit" name="submit" value="pickupSearch" class="btn-lg btn-primary ">搜尋</button>
...
<c:choose> 
  <c:when test="${ResultOrders != null}">
	...
	<div class="container table-responsive bg-warning" style=" border-radius:20px">
	  ...
	  <form name="searchform" method="post" action="../SubmitToShipped" style="font-size: 100%; vertical-align: baseline; 
	  ...
	  padding: 15px; " class="form-inline container">
	    ...
	    <table class="table table-bordered table-hover table-condensed pull-left" style="margin:0 0 0 -15px">
	      ...
	      <tr>
	        ...
	        <td>${i.getCOrderMaster().getShippingDate()}</td>
	        <td>icon</td>
	        <td>${i.getCOrderMaster().getOrderStatus()}<input type="hidden" name="status" value="${i.getCOrderMaster().getOrderStatus()}"></td>
	        <td>${i.getCOrderMaster().getTotalPrice()}</td>
	        <td>${i.getCOrderMaster().getStaffName()}</td>
	      </tr>
	      <tr>
