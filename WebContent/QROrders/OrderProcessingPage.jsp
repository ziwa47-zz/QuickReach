<%@page import="tw.iii.qr.order.SessionRecord"%>
...
<jsp:useBean id="SessionRecord" class="tw.iii.qr.order.SessionRecord" scope="page" />
    ...
    <c:when test="${SearchOrdersResult != null}">
      <div class="container table-responsive bg-warning" style=" border-radius:20px">
        <form name="searchform" method="post" action="../StatusDo" class="form-inline container"
          ...
          <div class="row text-center" >
            <button type="submit" name="send" value="processing" class="btn-lg btn-primary">送出</button>
          </div>
        </form>
      </div>
