  ...
  <form name="Homeform" method="post" action="HomePageChoose" style="font-size: 100%; vertical-align: baseline; " class=" form-group container">
    ...
    <div class="container bg-info text-center" style= "padding:10px 10px 10px 10px">
      <div class="row" style=" padding:10px 10px 10px 10px">
        ...
        <div class="col-md-2" style="font-size:24px;"> <a href="QRProduct/PurchaseRecordPage.jsp">進貨紀錄</a> </div>
        <div class="col-md-2" style="font-size:24px;"> <a href="QRProduct/ProductAddPage.jsp">新增商品</a> </div>
      ...
      <hr/>
      <div class="row" style="font-size:36px; padding:10px 10px 10px 10px">
        <div class="col-md-4"> <a href="QREmployee/Account.jsp" ><img src="img/users.png">員工管理</a> </div>
        <div class="col-md-2" style="font-size:24px;"> <a href="QREmployee/Account.jsp">新增員工</a> </div>
        <div class="col-md-2" style="font-size:24px;"> <a href="#">查詢員工</a> </div>
      </div>
      <hr/>
      <div class="row" style="font-size:36px; padding:10px 10px 10px 10px">
   ...
   ${PageCompetence.getProductManage()}
