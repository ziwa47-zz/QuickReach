...
<div class="nav">
  <div class="container" style="background:#99C61D; border-radius:20px;">
    <form name="searchform" method="post" action="/QRIndependentOrder/Finished" class="form-inline container"
    style="font-size: 100%; vertical-align: baseline; padding: 15px;">
      <fieldset class="font-weight" style="padding:0 30px 0 0;">
        ...
        <div class="row text-center" >
          <input type="hidden" name="IDPFinished"  value="IDPFinished"> <!-- 控制搜尋結果在處理中 -->
          <button class="btn btn-lg btn-primary" type="submit" name="submit" value="IDPFinishedSearch">搜尋</button>
  ...
  <hr/>
     ...
     <button type="submit" name="send" value="printdailyreport" class="btn btn-md btn-info">列印日出貨報表</button>
          <ul class="pager pagination">
            ...
            <c:forEach begin="0" end="${IDPfinished.size()/10}" step="1" varStatus="check">
              <c:choose>
            ...
            <c:choose>
              <c:when test="${end < IDPfinished.size()}">
            ...
            <label>共有:${IDPfinished.size()}筆</label>
          </ul>
