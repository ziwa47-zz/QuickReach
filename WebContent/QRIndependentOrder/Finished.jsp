              ...
              <c:choose>
                <c:when test="${check.index%2 != 0}">
                  <tr style="background-color:#D4F4D8">
                    <td rowspan="3" style="vertical-align:middle"><input type="checkbox" name="QR_id" value="${i.getIordersMaster().getQrId()}" onchange="preventDoubleOrder(this)"></td>
                    ...
                    <td>${i.getIordersMaster().getOrderStatus()}</td>
                    <td>${i.getIordersMaster().getTotalPrice()}</td>
                ...
                <c:otherwise>
                  <tr>
                    ...
                    <td><a href="OrderDetail.jsp?QR_id=${i.getIordersMaster().getQrId()}"><img src="../img/compose-4.png" ></a></td>
                    <td>
                      <input type="hidden" name="orderId" value="${i.getIordersMaster().getTransactionId()}"></td>
                    <td><a href="#"><img src="../img/compose.png" ></a></td>
                    <td>${i.getIordersMaster().getPlatform()}</td>
                    <td><a href="#">${i.getIordersMaster().getGuestId()}</a></td>
                    <td>${i.getIordersMaster().getPayDate()}</td>
                    <td></td>
                    <td>${i.getIordersMaster().getLogistics()}</td>
