  ...
  class="form-inline container">
    <fieldset>
      ...
      <div class="row text-center">
        <button type="submit" name="submit" value="getProcuctNewIDP" class="btn-lg btn-success">搜尋</button>
...
<c:choose>
  <c:when test="${productall != null}">
    <div class="container table-responsive bg-warning" style="border-radius: 20px">
      <form name="searchform" method="post" action="/QRIndependentOrder/IDPStatusDo" style="font-size: 100%; vertical-align: baseline; padding: 15px;" class="form-inline container">
