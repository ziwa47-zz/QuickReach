			...
			<div class="navbar-left" style="background-color: #BCF1E5;">
				<ul class="nav nav-tabs">
					<li class="" style="background-color: #1CAF9A"><a
						href="SearchStockPage.jsp" style="color: #FFFFFF">供應商管理</a></li>
					<li><a href="SearchProductPage.jsp" style="color: #000000">倉庫管理</a></li>
				</ul>
			</div>
		</div>
		<div class="container">
			<div class="nav" style="background-color: #1CAF9A;">
				<ul class="nav nav-tabs">
					<li><a href="SearchStockPage.jsp" style="color: #000">查詢供應商</a></li>
					<li><a href="PurchasePage.jsp" style="color: #000">新增供應商</a></li>
					<li class="" style="background-color: #1CAF9A"><a
	...
	<div class="container container-fluid breadcrumbBox">
		<ol class="breadcrumb">
			...
			<li class="active" style="display:"><a
				href="SearchStockPage.jsp">管理</a></li>
			<li><a href="PurchaseRecordPage.jsp">供應商管理</a></li>
		</ol>
	</div>
					...
					<div class="col-md-4 form-group ">
						<div class="row">
							...
							<div class="col-md-8">
								...
								<label class="checkbox-inline" style="margin-top: 7"><input
									type="checkbox" name="outRecord" value="outRecord">出貨記錄</label>
							</div>
						</div>
					</div>
				</div>
				...
				<div class="row">
					<div class="col-md-4 form-group ">
						<div class="row">
							...
							<div class="col-md-8">
								<input class="form-control" type="text" name="purchaseId"
									id="purchaseId">
							</div>
						</div>
					</div>
...
<%-- 									</c:forEach> --%>
				...
				<div class="row text-center">
					<input type="submit" name="Record" value="搜尋"
...
<!-- 									<th>成本</th> -->
<%-- 									<td><c:out value="${i.get(12)}"></c:out></td> --%>
